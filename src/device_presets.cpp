...
const QVector<DevicePreset> kPresets = {
    {QStringLiteral("generic"), QStringLiteral("Inkcut"), QStringLiteral("Generic"), 600, 400,
     PlotProtocol::HPGL, 1, false, false, false, 9600},
    {QStringLiteral("roland-stika-15"), QStringLiteral("Roland"), QStringLiteral("Stika SV-15"), 381,
     381, PlotProtocol::HPGL, 1, true, false, false, 9600},
    {QStringLiteral("roland-pnc900"), QStringLiteral("Roland"), QStringLiteral("PNC-900"), 304.8,
     304.8, PlotProtocol::CAMM_GL1, 1, false, false, false, 9600},
    {QStringLiteral("graphtec-ce6000"), QStringLiteral("Graphtec"), QStringLiteral("CE6000-60"),
     762, 609.6, PlotProtocol::HPGL, 1, false, false, false, 9600},
    {QStringLiteral("uscutter-mh"), QStringLiteral("US Cutter"), QStringLiteral("MH Series"), 762,
     609.6, PlotProtocol::HPGL, 1, false, false, false, 9600},
    {QStringLiteral("silhouette-cameo"), QStringLiteral("Silhouette"), QStringLiteral("Cameo"), 304.8,
     304.8, PlotProtocol::HPGL, 1, false, false, false, 9600},
    {QStringLiteral("anagraph-ae70e"), QStringLiteral("ANAgraph"), QStringLiteral("AE-70e"), 760,
     12000, PlotProtocol::HPGL, 1, true, false, false, 9600},
    {QStringLiteral("grbl"), QStringLiteral("GRBL"), QStringLiteral("CNC (serial)"), 300, 300,
